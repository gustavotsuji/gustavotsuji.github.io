...
\begin{tabular}{rl}
  \textsc{About me:}   & 34 years old and engaged. I am looking for a place where I can keep learning \\
...
\textsc{ } & Javascript Developer at \textsc{Ammo Varejo} \\\textsc{Sep 2019}&\emph{Bedding, bath and home decór marketplace }\\&\footnotesize{ 
...
\textbf{Technologies used:} Javascript, Node, Postgres, Kubernetes, Docker \newline
\textbf{Services used:} AWS (S3, RDS, CloudFront, EKS, ECR)}\\\multicolumn{2}{c}{} \\


 \textsc{ Sep 2019 } & Java/Javascript Backend Developer at \textsc{PagueMob} \\\textsc{Mar 2018}&\emph{Software house }\\&\footnotesize{
   
  Worked with two teams, one in Brazil and another in Mexico \newline
