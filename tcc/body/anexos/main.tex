...
A princípio o silhoutte score seria uma métrica de avaliação para definir a quantidade ideal de clusters para a execução do K Médias. Contudo, essa métrica não foi implementada no Spark, sendo útil apenas para uma análise exploratória.
