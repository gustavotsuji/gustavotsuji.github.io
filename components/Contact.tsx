        ...
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row justify-center items-center gap-6">
            <a
              ...
              className="group flex flex-col items-center p-6 bg-white dark:bg-gray-700 rounded-xl hover:shadow-xl transition-all duration-300 hover:-translate-y-1 w-full sm:w-auto sm:min-w-[200px]"
            >
              <div className="p-4 bg-primary-100 dark:bg-primary-900/30 rounded-full mb-4 group-hover:bg-primary-200 dark:group-hover:bg-primary-900/50 transition-colors">
                <svg
